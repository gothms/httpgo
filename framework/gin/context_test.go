...
import (
	...
	testdata "github.com/gothms/httpgo/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/gothms/httpgo/framework/gin.handlerNameTest$", c.HandlerName())
}
